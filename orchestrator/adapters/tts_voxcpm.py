"""VoxCPM TTS adapter — thin httpx client.

VoxCPM exposes the same public contract as Svara (POST /v1/audio/speech,
GET /v1/voices), with two extra optional knobs (`cfg_value`,
`inference_timesteps`) that get forwarded via kwargs.
"""
